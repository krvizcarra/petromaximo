  ...
  <section id="hero" class="d-flex justify-cntent-center align-items-center">
    <div id="heroCarousel" class="container carousel carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Su mejor opción</h2>
          <p class="animate__animated animate__fadeInUp">
          <h4>Distribución, servicio y calidad son nuestra mejor garantía de la
            fidelidad de nuestros clientes.</h4>
          </p>
        </div>
      </div>
...
export default {
  ...
  mounted() {
    ...
    window.scrollTo(0, 0),
      document.title = 'PetroMaximo - Servicio de comercialización'
  },
